...
export const actFetchUsers = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error.response?.data?.content || "Failed to load user list");
    }
  }
);
...
export const actDeleteUser = createAsyncThunk(
  ...
  async (taiKhoan, { dispatch, rejectWithValue }) => {
    try {
      ...
      const msg = error.response?.data?.content || "Delete failed!";
      alert(msg);
...
export const actUpdateUser = createAsyncThunk(
  ...
  async (user, { dispatch, rejectWithValue }) => {
    try {
      ...
      const msg = error.response?.data?.content || "Update failed!";
      alert(msg);
      return rejectWithValue(msg);
    }
  }
...
export const actSearchUser = createAsyncThunk(
  ...
  async (tuKhoa, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error.response?.data?.content || "Search error");
    }
  }
);
